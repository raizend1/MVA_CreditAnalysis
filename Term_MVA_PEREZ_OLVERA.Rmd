...
# levels(credit$PAY_0) <- c("No consumption", "Paid in full","The use of revolving credit","Payment delay for one month","Payment delay for two months")
