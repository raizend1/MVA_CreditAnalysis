...
#plotPCA(credit.PCA$ind$coord[,1:3], 5)

#credit.hcpc <- HCPC(credit.MCA)

# library(rpud)
# d <- rpuDist(credit)
# credit.hcpc <- rpuHclust(d)
# #cleaning up the house
# rm(credit.hcpc)
# gc()
```
...
This dataset involves obviously a prediction problem. The multivariate analysis we done so far had helped us to identify concepts that were not so obvious. In this part we will construct Random forest and a Desicion tree predictive models, then check and compare their predictive values. 
