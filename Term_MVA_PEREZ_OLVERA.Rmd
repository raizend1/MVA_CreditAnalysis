...
cl <- makeCluster(detectCores())
registerDoParallel(cl)
credit.importance <- Boruta(default.payment.next.month~., data = credit, doTrace = 2)
stopCluster(cl)
...
#first we check target variable distribution
tt<-table(credit$default.payment.next.month)
```
